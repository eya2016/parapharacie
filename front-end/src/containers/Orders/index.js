                                ...
                                return (
                                    <div key={order._id} className="Order">
                                        ...
                                        <div className="OrderDescription">
                                            <div className="od1">
                                                <p className="odtitle">Addresse de Livraison</p>
                                            ...
                                            <div className="od3">
                                                <p className="odtitle">Statut de paiement</p>
                                        ...
                                        <div className="OrderFooter">
                                            <p>Commandé le <span>{this.formatDate(order.orderDate)}</span></p>
                                            <p>Total de commande  <span>{this.getOrderTotal(order._id)} DT</span></p>
                                        </div>
                                    </div>
                                )
                            })
