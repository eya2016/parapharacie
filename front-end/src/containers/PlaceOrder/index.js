                        ...
                        <div className="DeliveryAddress">
...

                            {
                                this.state.isAddressConfirm ? 
                                 <div className="Card">
                                     <p className="CardText">Addresse de Livraison {this.state.isAddressConfirm ? <i className="fas fa-check"></i> : null}</p>
                                     <p>
                                ...
                                <div className="Card">
                                    ...
                                    }
                                    {
                                        ...
                                        <div className="DeliveryButtonContainer" >
                                            <button onClick={this.confirmDeliveryAddress} className="DeliveryAddressButton">Passer la livraison</button>
                                        </div> : null
                                    }
...

                                {
                                    ...
                                    <div className="Card">
                                        <p className="CardText">Récap de la commande <i className="fas fa-check"></i> </p>
                                    </div> : 
                                    this.state.isAddressConfirm ? 
                                    <div className="Card">
                                        <h4 className="CardText">Récap de la commande </h4>
                                        {
                                        ...
                                        <button onClick={this.confirmOrder} className="ContinueButton">Continuer</button>
                                    </div>
                                 : null
                                }
                                
                                {
                                    ...
                                    </ul>
                                    {
                                        ...
                                        <p className="ErrorMessage">Désolé, seul le paiement à la livraison est disponible</p> : null
                                    }
                                    <button className="PaymentConfirm" onClick={this.submitOrder}>Confirmer la commande</button>
