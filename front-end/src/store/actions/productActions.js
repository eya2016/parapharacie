...
export const GET_PRODUCT_PROMOS = 'GET_PRODUCT_PROMOS';
...
export const getProducts = (categorySlug = '', filter) => {
    return async dispatch => {
        ...
        try{
            ...
            // let tab = Object.values(jsonResponse);
            // let produits = tab[0].filter(e => e.offer === 1 );
            // console.log(" ====> premier PRODUCT ==>  ", tab[0]);
...
export const getProductsPromos = () => {
    return async dispatch => {
        ...
        try{
            ...
            let tab = Object.values(jsonResponse);
            let produits = tab[0].filter(e => e.offer !== 1 );
            console.log(" ====> liste des produits en PROMOS ==>  ", produits ,"\n ****************************** \n ");
            if(response.status === 200){
                dispatch({
                    type: GET_PRODUCT_PROMOS,
                    products: produits
                });
            }
