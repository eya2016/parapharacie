            ...
            <div className="Content">
                    ...
                    <div className="ContentBody">
                        <div className="SideMenu">
                            <h3 className="SideMenuTitle">Filterer Par: </h3>
                            <div className="Filter">
                                <p className="FilterTitle">Catégories</p>
                                <ul>
                                    {
                           ...
                           <div className="Filter">
                               ...
                               <div>
                                    <button onClick={() => this.applyFilter({price:1} )} className="FilterButton">Croissant</button>
                               </div>
                               <div>
                                    <button onClick={() => this.applyFilter({price: -1})} className="FilterButton">Décroissant</button>
                               </div>
